...
/**
 * Fetch airport data from GitHub CSV
 * Using OpenFlights dataset: https://github.com/jpatokal/openflights
 */
 ...
 */
export const searchAirports = (airports: Airport[], query: string): Airport[] => {
